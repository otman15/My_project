...
def run_all(save=False, Pause = True): 
    ...
    groupes = ['Welch_indicators', 'Toutes_vars', 'Tous_groupes',None,'Prix', 'Monnaie_credit',
               'Production_Revenus', 'Marche_de_travail', 'Logement', 'Conso_Ordres' , 
               'Taux_interet_change',  'Marches_Boursiers']
